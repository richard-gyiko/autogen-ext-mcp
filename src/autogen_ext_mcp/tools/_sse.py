...
class SseMcpToolAdapter(
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            import asyncio
            from autogen_ext_mcp.tools import SseMcpToolAdapter, SseServerParams
    ...
    component_provider_override = "autogen_ext_mcp.tools.SseMcpToolAdapter"
